                        ...
                        <div class="table-responsive">
                            @if (Session::has('success_message'))
                                        <div class='alert-success'>
                                            <strong>Success | Item added successfully! {{ Session::get('message_success') }}</strong>
                                        </div>
                                    @endif
                                    @if (Cart::count() > 0) 
                                        ...
                                        <table class="table">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="cart_total_amount"><span class="font-lg fw-900 text-brand">Ar {{ Cart::subtotal() }}</span></td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="cart_total_amount"><strong><span class="font-xl fw-900 text-brand">Ar {{ Cart::total() }}</span></strong></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
